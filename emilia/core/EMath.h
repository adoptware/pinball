...
/**
 * <p>A class that collects all math functions.
 * The math functions are equal to Allegros math functions. The are
 * added to the Emilia code only to make porting easier.</p>
 * <p>None of the functions create any objects or structures.</p>
 */
class EMath {
	public:
		EMath();
