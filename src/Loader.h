// #ident "$Id: Loader.h,v 1.15 2003/07/16 20:02:04 rzr Exp $"
/***************************************************************************
...
class Loader {
 ...
 private:
  ...
  int cmpVersion(const FileVersion & ver, const int major, const int minor, const int micro) const;
...
//EOF $Id: Loader.h,v 1.15 2003/07/16 20:02:04 rzr Exp $
